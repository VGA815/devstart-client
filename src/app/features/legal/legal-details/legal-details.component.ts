...
export class LegalDetailsComponent {
  ...
  readonly details = [
    ...
    { label: 'Юридически значимые документы', value: 'Публичная оферта, политика конфиденциальности, пользовательское соглашение и согласие на обработку персональных данных' },
  ];
